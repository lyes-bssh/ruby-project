...
# 1. Trouver le nombre de journalistes 
...
# 2. Trouver le handle le + court

puts " "

puts "-- Trouver le handle le + court --"

puts list.min{|a,b| a.size <=> b.size }

puts "________________________________________"



# 3. Combien de handle avec 5 lettres 
...
# 4. Combien de handle commencent par une majuscule 
...
# 6. Trier les handle du + petit au + grand

puts " "

puts "-- Trier les handle du + petit au + grand --"
...
# 7. Contrôler la position de @epenser 
...
# 8. Répartir les handle par taille 
